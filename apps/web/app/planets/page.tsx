...
export default function PlanetsPage() {
  ...
  const fetchAllPlanets = async () => {
    try {
      ...
      // Usar datos mockeados en lugar de llamada a API
      const mockPlanets = mockedPlanets;
      setPlanets(mockPlanets);
      setFilteredPlanets(mockPlanets);
    } catch (err) {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-slate-900 via-[#637278] to-slate-900">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-[#637278] to-slate-900">
        <div className="container mx-auto px-4 py-8">
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Error al cargar los planetas: {error}
            </AlertDescription>
          </Alert>
        </div>
      </div>
        ...
        {filteredPlanets.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-slate-400 text-lg">
              No se encontraron planetas con los filtros aplicados
            </p>
          </div>
        ) : (
